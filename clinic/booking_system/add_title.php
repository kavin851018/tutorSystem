...
<body>
<form name="form1" method="post" action="add_title2.php">
<table width="600" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#336600">
  <tr>
    <td><div align="center" class="title">Add a class </div></td>
  </tr>
  <tr>
    <td bgcolor="white"><span class="content">Title:</span>	 <input name="title" type="text" id="title" maxlength="32">
        <font color="#FF0000" size="2">(不可有空格且課名請勿重複)</font></td>
  </tr>
  <tr>
    <td bgcolor="white"><span class="content">Select the Location:</span>      <select name="location" id="location">
        ...
        <option value="NIGHT">dormitory</option>
      </select></td>
  </tr>
  <tr>
    <td bgcolor="white"><div align="center"><span class="content">Time Table: </span><br>      
        ...
        <table width="500" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#FF6600">
          ...
          <tr bgcolor="white"> 
            ...
            <td width="75" bgcolor="#FFECCE"><div align="center"> 
                <input name="monday10" type="checkbox" id="monday9" value="4">
              </div></td>
            <td width="75" bgcolor="#FFECCE"><div align="center"> 
                <input name="tuesday10" type="checkbox" id="tuesday9" value="4">
              </div></td>
            <td width="75" bgcolor="#FFECCE"><div align="center"> 
                <input name="wednesday10" type="checkbox" id="wednesday9" value="4">
              </div></td>
            <td width="75" bgcolor="#FFECCE"><div align="center"> 
                <input name="thursday10" type="checkbox" id="thursday9" value="4">
              </div></td>
            <td width="75" bgcolor="#FFECCE"><div align="center"> 
                <input name="friday10" type="checkbox" id="friday9" value="4">
              </div></td>
          </tr>          
          <tr bgcolor="white"> 
            <td bgcolor="#FFDEC8" class="content"><div align="center">19:00~20:00</div></td>
            <td width="75" bgcolor="white"><div align="center"> 
                <input name="monday11" type="checkbox" id="monday10" value="2">
              </div></td>
            <td width="75" bgcolor="white"><div align="center"> 
                <input name="tuesday11" type="checkbox" id="tuesday10" value="2">
              </div></td>
            <td width="75" bgcolor="white"><div align="center"> 
                <input name="wednesday11" type="checkbox" id="wednesday10" value="2">
              </div></td>
            <td width="75" bgcolor="white"><div align="center"> 
                <input name="thursday11" type="checkbox" id="thursday10" value="2">
              </div></td>
            <td width="75" bgcolor="white"><div align="center"> 
                <input name="friday11" type="checkbox" id="friday10" value="2">
              </div></td>
          </tr>
          <tr bgcolor="white"> 
            <td bgcolor="#FFDEC8" class="content"><div align="center">20:00~21:00</div></td>
            <td width="75" bgcolor="#FFECCE"><div align="center"> 
                <input name="monday12" type="checkbox" id="monday11" value="1">
              </div></td>
            <td width="75" bgcolor="#FFECCE"><div align="center"> 
                <input name="tuesday12" type="checkbox" id="tuesday11" value="1">
              </div></td>
            <td width="75" bgcolor="#FFECCE"><div align="center"> 
                <input name="wednesday12" type="checkbox" id="wednesday11" value="1">
              </div></td>
            <td width="75" bgcolor="#FFECCE"><div align="center"> 
                <input name="thursday12" type="checkbox" id="thursday11" value="1">
              </div></td>
            <td width="75" bgcolor="#FFECCE"><div align="center"> 
                <input name="friday12" type="checkbox" id="friday11" value="1">
              </div></td>
          </tr>
        </table>    </td>
  </tr>
