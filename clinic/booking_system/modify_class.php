...
$sql = "Select * From class_title Where id='$id'";
...
<body>
<form action="modify_class2.php" method="post" enctype="application/x-www-form-urlencoded" name="form1">

  <table width="500" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#FF6600">
    <tr bgcolor="#FFA86F" class="title"> 
      <td colspan="6" align="center"> <input name="title_name" type="text" id="title_name" value="<?php echo $title_name;?>"></td>
    </tr>
