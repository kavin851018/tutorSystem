	...
	<table class="ui center aligned celled table create_schedule">
		...
		while($schedule = mysql_fetch_array($get_schedule)){
			...
			<tr id="schedule'.$schedule['rno'].'">
				...
				<td class="editable">'.$schedule['semester'].'</td>
				<td class="editable">'.$schedule['desc'].'</td>
				<td class="editable">'.str_replace('-',',',$schedule['mon']).'</td>
				<td class="editable">'.str_replace('-',',',$schedule['tue']).'</td>
				<td class="editable">'.str_replace('-',',',$schedule['wed']).'</td>
				<td class="editable">'.str_replace('-',',',$schedule['thu']).'</td>
				<td class="editable">'.str_replace('-',',',$schedule['fri']).'</td>
	...
	<table class="ui selectable celled padded center aligned table">
		...
		while($tutor = mysql_fetch_array($get_tutor)){
			...
			<tr id="tutor'.$tutor['rno'].'">
				...
				<td><button type="button" class="ui red compact basic button tutor-delete" data-rno="'.$tutor['rno'].'">刪除</button></td>
			</tr>';
		}
		echo '
		<tr id="create_tutor">
